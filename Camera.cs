...
namespace Ant
{
    class Camera
    {
        readonly double[] camPos = new double[3];
        readonly double[] camDir = new double[3];
        readonly double[] upDir = new double[3];
        public Camera()
        {
            camPos[0] = 0.0;
            camPos[1] = 0.0;
        ...
        public void SetViewVolume(double fovy, int FrameWidth, int FrameHeight, double near, double far)
        {
            ...
            Gl.glMatrixMode(Gl.GL_PROJECTION);
            Gl.glLoadIdentity();
            double aspect = (double)FrameHeight / FrameWidth;
            double x_extent = 0.1;
        ...
        private void ReduceToUnit(double[] vector)
        {
            ...
            length = Math.Sqrt(vector[0] * vector[0] +
